...
class AzurermTfVarsComputed():
    ...
    def _process_nested_computed(self, nested_count_parent, parent_set, tf_resource_type, tf_resource_var_name,
                                 nested_atr_name, nested_atr, schema_nested, resource_object_parent):
        try:
            ...
            if isinstance(nested_atr, dict):
                ...
                self._process_dict_computed(nested_count, parent_set, tf_resource_type, tf_resource_var_name,
                                            nested_atr_name, nested_atr, schema, resource_object_parent)
    ...
    def _process_dict_computed(self, nested_count_parent, root_parent_set, tf_resource_type, tf_resource_var_name,
