from duplocli.terraform.providers.azurerm.azurerm_vars_computed import AzurermTfVarsComputed
...
class AzurermTfVarsExtract(AzureBaseTfImportStep):
    ...
    def _tf_resources(self):
        ...
        self.resource_computed = {}
        self.vars_state_tf_names = {}
        self.vars_state_tf_ids = {}
        self.computed_utils = AzurermTfVarsComputed(self)
    ...
    def _resource_array_by_type(self):
        for resource in self.state_resources:
            try:
                ...
                if not tf_resource_type in self.resource_computed:
                    self.resource_computed[tf_resource_type] = []
                ...
                attributes["tf_type"] = tf_resource_type
                attributes["tf_var_name"] = tf_resource_var_name
                resource_object = {}
                self.computed_utils._resource_array_by_type_computed(attributes, resource_object)
    ...
    #
    # def _resource_array_by_type_required(self):
    #     pass
    #
    # def _resource_array_by_type_optional(self):
    #     pass
    #
    # ######  TfImportStep3 ################################################
    #
    ...
    #     self.file_utils.save_json_to_work_folder("value_computed.json", self.value_computed)
    #     self.file_utils.save_json_to_work_folder("vars_tf.json", self.vars_tf)
    #     self.file_utils.save_json_to_work_folder("vars_state_tf.json", self.resource_array_by_type)
    #
    #     self.file_utils.save_json_to_work_folder("vars_state_tf_names.json", self.vars_state_tf_names)
    #     self.file_utils.save_json_to_work_folder("vars_state_tf_ids.json", self.vars_state_tf_ids)
    #
    ...
    #     print(json.dumps(list(self.value_computed)))
    #     print( json.dumps(self.vars_tf))
    #     print(json.dumps(self.resource_array_by_type))
    #
    #     return self.main_tf_json_dict
    #
    #
