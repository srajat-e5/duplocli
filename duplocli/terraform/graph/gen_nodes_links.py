...
class GenNodesLinks:
    ...
    def process_tfstate(self, tf_state_file, graph_folder_name):
        ...
        self.graphData_all.tf_resources_var_to_ids = self.merge_dict(self.graphData_all.tf_resources_var_to_ids,
                                                                     graphData.tf_resources_var_to_ids)
        self.graphData_all.tf_resources_links = self.merge_dict(self.graphData_all.tf_resources_links,
                                                                graphData.tf_resources_links)
        self.graphData_all.tf_resources_parent_links = self.merge_dict(self.graphData_all.tf_resources_parent_links,
                                                                       graphData.tf_resources_parent_links)
