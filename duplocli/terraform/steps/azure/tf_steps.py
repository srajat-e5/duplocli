...
from duplocli.terraform.steps.azure.tf_step1 import AzureTfImportStep1
from duplocli.terraform.steps.azure.tf_step2 import AzureTfImportStep2
...
class AzureTfSteps:
    ...
    def _init_step1(self):
        self.step1 = AzureTfImportStep1(self.params)
        return self.step1

    def _init_step2(self):
        self.step2 = AzureTfImportStep2(self.params)
        return self.step2
