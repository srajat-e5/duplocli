...
class TfUtils:
    ...
    def empty_output_folder(self, step):
        cmd_mod = "mkdir -p  log; mkdir -p {0}; rmdir /s /q {0}\\*; dir  {0}".format(self.get_tf_output_path(step))
        print("empty_output_folder", cmd_mod)
        os.system(cmd_mod)
        print("DONE empty_output_folder", cmd_mod)

    def create_output_folder(self, step):
        cmd_mod = "rmdir /s /q {0}\\*; mkdir -p  {0}".format(self.get_tf_output_path(step))
    ...
    def create_state(self, tf_run_script_file, step):
        ...
        print("create_state ", tf_run_script_file)
        os.system(tf_run_script_file)
